...
abstract final class GithubTesisGorselDataSource {
  ...
  static Uri get _uri => GithubTesisGorselConfig.uri;
  ...
  static Future<String?> fetchRemoteVersion() async {
    try {
      ...
      if (res.statusCode != 200) {
        _log('Tesis görsel sürüm kontrolü başarısız: HTTP ${res.statusCode}');
        return null;
      }
      ...
      _log('Tesis görsel sürüm kontrolü hatası: $e', st);
      return null;
    }
  }
  ...
  static Future<String?> fetchFromGitHub() async {
    try {
      ...
      if (res.statusCode != 200) {
        _log(
          'Tesis görselleri indirilemedi: HTTP ${res.statusCode} '
          '(${GithubTesisGorselConfig.rawUrl})',
        );
        return null;
      }
      ...
      _log('Tesis görselleri indirme hatası: $e', st);
      return null;
    }
  }

  static void _log(String message, [StackTrace? st]) {
    debugPrint('[GithubTesisGorselDataSource] $message');
